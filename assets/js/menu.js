		...
		function swapMenuStyle() {
			if (window.pageYOffset > stickyDesktop) {
                ...
                logo.classList.remove("logo-grey");

			} else {
				headerDesktop.classList.add("menu-transparent","logo-light");
				headerDesktop.classList.remove("menu-light","menu-drop-shadow","logo-grey");
				headerMobile.classList.add("menu-transparent","logo-light");
                headerMobile.classList.remove("menu-light","menu-drop-shadow","logo-grey");
                logo.classList.add("logo-grey");
